	...
	return (
		<div className="md:max-w-[60vh] max-w-48 bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
			...
			<div className="px-5 pb-5">
				<h5 className="text-lg text-center font-medium tracking-tight text-gray-900 dark:text-white">
					{bestItem.name}
				</h5>
				...
				<div className="flex md:flex-row flex-col justify-between gap-2 mt-3">
					<div className="flex flex-col items-center mt-3">
						...
						<h3 className="text-2xl font-medium text-gray-800 my-auto dark:text-white">
							Rp. {revenue}
						</h3>
					</div>
					<div className="flex flex-col items-center mt-3">
						...
						<span className="mx-2 w-full grid text-md font-normal text-gray-800 text-center dark:text-white">
